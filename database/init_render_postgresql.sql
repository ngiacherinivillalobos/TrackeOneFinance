-- Script de inicialização para PostgreSQL no Render
-- Este script será executado automaticamente quando o banco for criado
...
CREATE INDEX IF NOT EXISTS idx_transactions_status ON transactions(payment_status_id);
...
BEGIN 
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_cash_flow_updated_at') THEN
